...
class testMeetingConfig(MeetingIDEATestCase, mctmc):
    ...
    def test_subproduct_call_SearchItemsToValidateOfEveryReviewerLevelsAndLowerLevels(self):
        ...
        self.failUnless(len(self.meetingConfig.searchItemsToValidateOfEveryReviewerLevelsAndLowerLevels('', '', '', '')
                            ) == 2)
        ...
        self.failUnless(
            self.meetingConfig.searchItemsToValidateOfEveryReviewerLevelsAndLowerLevels('', '', '', ''
                                                                                        )[0].UID == item2.UID())
