...
from Products.MeetingIDEA.config import FINANCE_ADVICE_LEGAL_TEXT
from Products.MeetingIDEA.config import FINANCE_ADVICE_LEGAL_TEXT_NOT_GIVEN
from Products.MeetingIDEA.config import FINANCE_ADVICE_LEGAL_TEXT_PRE
